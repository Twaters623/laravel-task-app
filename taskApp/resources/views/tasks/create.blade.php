...
<div class="max-w-2xl mx-auto p-6 bg-white text-gray-900 rounded-lg shadow-lg">
    ...
    <form action="{{ route('tasks.store') }}" method="POST">
        ...
        <div class="mb-6">
            ...
            <input type="text" name="task_name" id="task_name" class="mt-2 mb-2  block w-full bg-gray-100 border border-gray-300 text-gray-900 rounded-md shadow-sm focus:ring-purple-500 focus:border-purple-500 placeholder-gray-500" placeholder="e.g., Take out trash" oninvalid="this.setCustomValidity('Please enter a valid task name')"
...
oninput="this.setCustomValidity('')" required>
        ...
        <div class="mb-6">
            ...
            <input type="text" name="task_location" id="task_location" class="mt-2 mb-2  block w-full bg-gray-100 border border-gray-300 text-gray-900 rounded-md shadow-sm focus:ring-purple-500 focus:border-purple-500 placeholder-gray-500" placeholder="Kitchen, Garage"
...
title="Location can contain letters, numbers, spaces, hyphens, underscores and commas"
        ...
        <div class="mb-6">
            ...
            <input type="text" name="materials_required" id="materials_required" class="mt-2 mb-2  block w-full bg-gray-100 border border-gray-300 text-gray-900 rounded-md shadow-sm focus:ring-purple-500 focus:border-purple-500 placeholder-gray-500" placeholder="e.g., Trash Bags, Broom">
        </div>

        <!-- {{-- Deadline --}} -->
        <div class="mb-6">
            <label for="deadline" class="block text-sm font-medium text-purple-600">Deadline:</label>
            <input type="date" name="deadline" id="deadline" class="mt-1 block w-full bg-gray-100 border border-gray-300 text-gray-900 rounded-md shadow-sm focus:ring-purple-500 focus:border-purple-500">
        </div>
        ...
        <div class="mb-6">
            ...
            <input type="text" name="category" id="category" class="mt-2 mb-2  block w-full bg-gray-100 border border-gray-300 text-gray-900 rounded-md shadow-sm focus:ring-purple-500 focus:border-purple-500 placeholder-gray-500" placeholder="e.g., chores, work, health"
