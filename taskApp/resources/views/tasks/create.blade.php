    ...
    <div class="max-w-2xl mx-auto p-6 bg-white text-gray-900 rounded-lg shadow-lg">
        ...
        <form action="{{ route('tasks.store') }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <input type="text" name="task_name" id="task_name" class="mt-2 mb-2  block w-full bg-gray-100 border border-gray-300 text-gray-900 rounded-md shadow-sm focus:ring-purple-500 focus:border-purple-500 placeholder-gray-500" placeholder="e.g., Take out trash" > </div>
